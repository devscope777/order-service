...
public class OrderRepositoryR2dbcTests {
    ...
    @Container
    public static PostgreSQLContainer postgresql = new PostgreSQLContainer(DockerImageName.parse("postgres:13.4"));
    ...
    void whenCreateOrderAuthenticatedThenAuditMetadata() {
        ...
        StepVerifier.create(orderRepository.save(rejectedOrder))
                .expectNextMatches(
                        order -> order.createdBy().equals("melinda") && order.lastModifiedBy().equals("melinda"))
                .verifyComplete();
    }
}
